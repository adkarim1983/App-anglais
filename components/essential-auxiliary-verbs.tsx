          ...
          <CardContent className="pt-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 pl-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">I have</span> (j'ai)</p>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleSpeak('I have')}
                      className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                    >
                      <Volume2 className="h-3 w-3" />
                    </Button>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">You have</span> (tu as)</p>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleSpeak('You have')}
                      className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                    >
                      <Volume2 className="h-3 w-3" />
                    </Button>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">He/She/It has</span> (il/elle a)</p>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleSpeak('He has. She has. It has')}
                      className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                    >
                      <Volume2 className="h-3 w-3" />
                    </Button>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">We have</span> (nous avons)</p>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleSpeak('We have')}
                      className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                    >
                      <Volume2 className="h-3 w-3" />
                    </Button>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">You have</span> (vous avez)</p>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleSpeak('You have')}
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">They have</span> (ils/elles ont)</p>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => handleSpeak('They have')}
                      className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                    >
                      <Volume2 className="h-3 w-3" />
                    </Button>
            ...
            <div className="space-y-3">
              ...
              <div className="pl-4 space-y-2">
                <div className="flex items-center gap-2">
                  <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">I/You/He/She/It/We/They had</span></p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('I had. You had. He had. She had. It had. We had. They had')}
                    className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
                ...
                <div className="flex items-center gap-2">
                  <p className="text-sm text-slate-600 dark:text-slate-400 italic">Exemple : She had a great time (Elle a passé un bon moment)</p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('She had a great time')}
                    className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
            ...
            <div className="space-y-3">
              ...
              <div className="pl-4 space-y-2">
                <div className="flex items-center gap-2">
                  <p className="text-slate-700 dark:text-slate-300"><span className="font-semibold">I/You/He/She/It/We/They will have</span></p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('I will have. You will have. He will have. She will have. It will have. We will have. They will have')}
                    className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
                ...
                <div className="flex items-center gap-2">
                  <p className="text-sm text-slate-600 dark:text-slate-400 italic">Exemple : We will have dinner at 7 (Nous dînerons à 19h)</p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('We will have dinner at seven')}
                    className="h-6 w-6 p-0 hover:bg-slate-100 dark:hover:bg-slate-800"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
            ...
            <div className="space-y-3 bg-green-50 dark:bg-green-950/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
              <h4 className="text-lg font-bold text-green-800 dark:text-green-300">Exemples d'utilisation</h4>
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <p className="text-slate-700 dark:text-slate-300 flex-1">
                    <span className="font-semibold">I have a car.</span> → J'ai une voiture.
                  </p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('I have a car')}
                ...
                <div className="flex items-center gap-2">
                  <p className="text-slate-700 dark:text-slate-300 flex-1">
                    <span className="font-semibold">She has two brothers.</span> → Elle a deux frères.
                  </p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('She has two brothers')}
                    className="h-6 w-6 p-0 hover:bg-green-100 dark:hover:bg-green-900/50"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
                ...
                <div className="flex items-center gap-2">
                  <p className="text-slate-700 dark:text-slate-300 flex-1">
                    <span className="font-semibold">They had a meeting yesterday.</span> → Ils ont eu une réunion hier.
                  </p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('They had a meeting yesterday')}
                    className="h-6 w-6 p-0 hover:bg-green-100 dark:hover:bg-green-900/50"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
                ...
                <div className="flex items-center gap-2">
                  <p className="text-slate-700 dark:text-slate-300 flex-1">
                    <span className="font-semibold">We will have a party next week.</span> → Nous aurons une fête la semaine prochaine.
                  </p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('We will have a party next week')}
                    className="h-6 w-6 p-0 hover:bg-green-100 dark:hover:bg-green-900/50"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
                ...
                <div className="flex items-center gap-2">
                  <p className="text-slate-700 dark:text-slate-300 flex-1">
                    <span className="font-semibold">He has finished his homework.</span> → Il a fini ses devoirs.
                  </p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('He has finished his homework')}
                    className="h-6 w-6 p-0 hover:bg-green-100 dark:hover:bg-green-900/50"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
            ...
            <div className="space-y-3 bg-slate-50 dark:bg-slate-900/50 p-4 rounded-lg">
              <h4 className="text-lg font-bold text-slate-800 dark:text-slate-100">Formes contractées</h4>
              <div className="grid grid-cols-2 gap-2 text-sm">
                <p className="text-slate-700 dark:text-slate-300">I've = I have</p>
                <p className="text-slate-700 dark:text-slate-300">You've = You have</p>
                <p className="text-slate-700 dark:text-slate-300">He's = He has</p>
                <p className="text-slate-700 dark:text-slate-300">She's = She has</p>
                <p className="text-slate-700 dark:text-slate-300">We've = We have</p>
                <p className="text-slate-700 dark:text-slate-300">They've = They have</p>
                <p className="text-slate-700 dark:text-slate-300">I'd = I had</p>
                <p className="text-slate-700 dark:text-slate-300">I'll have = I will have</p>
              </div>
            </div>

            {/* Usage spécial */}
            <div className="space-y-3 bg-amber-50 dark:bg-amber-950/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
              <h4 className="text-lg font-bold text-amber-800 dark:text-amber-300">Usage spécial</h4>
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <div className="flex-1">
                    <p className="text-slate-700 dark:text-slate-300">
                      <span className="font-semibold">Have to</span> = devoir (obligation)
                    </p>
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak('I have to go now')}
                    className="h-6 w-6 p-0 hover:bg-amber-100 dark:hover:bg-amber-900/50"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex-1">
                    <p className="text-slate-700 dark:text-slate-300">
                      <span className="font-semibold">Have got</span> = avoir (britannique)
                    </p>
                    <p className="text-slate-600 dark:text-slate-400 italic pl-4">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleSpeak("I've got a question")}
                    className="h-6 w-6 p-0 hover:bg-amber-100 dark:hover:bg-amber-900/50"
                  >
                    <Volume2 className="h-3 w-3" />
                  </Button>
